...
public interface IDatePeriodConfigurationOfWork 
{
    /// <summary>
    ...
    /// <summary>
    /// Создаёт и возвращает реализацию <see cref="IDatePeriodConfigurationOfWork"/>.
    /// </summary>
    ...
    /// <returns>Реализация <see cref="IDatePeriodConfigurationOfWork"/>.</returns>
    /// <exception cref="ArgumentNullException">
    /// Возникает, когда <paramref name="repository"/> или <paramref name="mapper"/>
    /// равны <see langword="null"/>.
    /// </exception>
    public static IDatePeriodConfigurationOfWork Create<TRepository>(TRepository repository, IDatePeriodConfigurationMapper mapper)
